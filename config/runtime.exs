...
#
#     PHX_SERVER=true bin/volfefe_machine start
#
...
if config_env() == :prod do
  ...
  config :volfefe_machine, :dns_cluster_query, System.get_env("DNS_CLUSTER_QUERY")
  ...
  #
  #     config :volfefe_machine, VolfefeMachine.Mailer,
