defmodule VolfefeMachineWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(VolfefeMachineWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(VolfefeMachineWeb.Gettext, "errors", msg, opts)
    end
  end
